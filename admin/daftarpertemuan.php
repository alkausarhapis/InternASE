            ...
            <tbody>
                <?php foreach ($meeting as $meetingItem) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <button class="icon-button" onclick="copyLink()" value="<?= $meetingItem['meeting_link'] ?>" id="meeting_link"><i class="fa-solid fa-link"></i></button>
                            <button class="icon-button" data-toggle="modal" data-target="#deleteMeeting"><i class="fa fa-trash"></i></button>
                            <button class="icon-button"><i class="fa-solid fa-ellipsis-vertical" data-toggle="modal" data-target="#deleteModal"></i></button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
                ...
                <div class="modal-body">
                    <form id="newMeetingForm" method="POST" action="code.php">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control mb-2" placeholder="Meeting name" required>
                        </div>
                        <div class="form-group">
                            <label for="speaker">Speaker:</label>
                            <input type="text" id="speaker" name="speaker" class="form-control mb-2" placeholder="Speaker" required>
                        </div>
                        <div class="form-group">
                            <label>Date:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                <div class="input-group ">
                                    <input type="time" class="form-control" name="start_time" id="end_time" placeholder="Start time (e.g., 11:00)" required>
                                </div>
                                <div class="input-group ml-2">
                                    <input type="time" class="form-control" name="end_time" id="end_time" placeholder="End time (e.g., 14:00)" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="link">Meeting Link:</label>
                            <input type="url" id="link" name="link" class="form-control mb-2" placeholder="Meeting Link" required>
                        </div>
                        <div class="form-group">
